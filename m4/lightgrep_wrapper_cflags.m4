...
#
################################################################
# bda - Changed to set LW_CFLAGS instead of CFLAGS
#       and LW_CXXFLAGS instead of CXXFLAGS
...
do
  ...
  AC_COMPILE_IFELSE([AC_LANG_PROGRAM([[]], [[]])],
      [has_option=yes; LW_CXXFLAGS="$LW_CXXFLAGS $option"],
      [has_option=no])
  AC_MSG_RESULT($has_option)
  unset has_option
